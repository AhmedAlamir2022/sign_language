                                            ...
                                            @if ($homework->inst_id == Auth::guard('instructor')->user()->id)
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="{{ route('download.inst.attachment', $homework->h_file) }}"
                                                            title="Download" class="btn btn-warning btn-sm"
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form
                                                                    action="{{ route('delete.insthomework', $homework->id) }}"
                                                                    method="post">
                                                                    @csrf
                ...
                <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog"
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <!-- add_form -->
                                <form action="{{ route('add.inst.homework') }}" method="post" autocomplete="off"
