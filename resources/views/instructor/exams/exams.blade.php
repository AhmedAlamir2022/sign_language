                                ...
                                <table id="datatable" class="table  table-hover table-sm table-bordered p-0"
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($exams as $exam)
                                            @if ($exam->inst_id == Auth::guard('instructor')->user()->id)
                                                <tr>
                                                    <?php $i++; ?>
                                                    <td>{{ $i }}</td>
                                                    <td>{{ $exam->name }}</td>
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form action="{{ route('delete.instexam', $exam->id) }}"
                                                                    method="post">
                                                                    @csrf
                    ...
                    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <!-- add_form -->
                                    <form action="{{ route('add.instexam') }}" method="post" autocomplete="off"
                                        ...
                                        <div class="section-field mb-20">
                                            ...
                                            <select class="form-control" name="subject_id" class="custom-select" required>
                                                <option value="" selected disabled> --------{{trans('exams_trans.Choose_Subject')}}-------
                                                </option>
