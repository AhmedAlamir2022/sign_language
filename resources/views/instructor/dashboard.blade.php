                    ...
                    <div class="card card-statistics h-100">
                        <div class="card-body">
                            ...
                            <p class="text-muted pt-3 mb-0 mt-2 border-top">
                                <a href="{{ route('all.inst.students') }}"><i class="fa fa-users mr-1" aria-hidden="true"></i> {{ trans('main_trans.All_Students') }}</a>
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card card-statistics h-100">
                        <div class="card-body">
                            <div class="clearfix">
                                ...
                                <div class="float-right text-right">
                                    <p class="card-text text-dark">{{ trans('main_trans.Homeworks') }}</p>
                                    <h4>{{ \App\Models\Homework::count() }}</h4>
                                </div>
                            </div>
                            <p class="text-muted pt-3 mb-0 mt-2 border-top">
                                <a href="{{ route('all.homeworks') }}"><i class="fa fa-calendar mr-1" aria-hidden="true"></i> {{ trans('main_trans.All_Homeworks') }}</a>
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card card-statistics h-100">
                        <div class="card-body">
                            <div class="clearfix">
                                ...
                                <div class="float-right text-right">
                                    <p class="card-text text-dark">{{ trans('main_trans.Exams') }}</p>
                                    <h4>{{ \App\Models\Exam::count() }}</h4>
                                </div>
                            </div>
                            <p class="text-muted pt-3 mb-0 mt-2 border-top">
                                <a href="{{ route('all.exams') }}"> <i class="fa fa-book mr-1" aria-hidden="true"></i>{{ trans('main_trans.All_Exams') }}</a>
                            </p>
                        </div>
                    </div>
                </div>
