                    ...
                    <div class="card card-statistics h-100">
                        <div class="card-body">
                            ...
                            <button type="button" class="button x-small" data-toggle="modal"
                                ...
                                {{trans('homework_trans.Add_New')}}</button><br><br>
                                ...
                                <table id="datatable" class="table  table-hover table-sm table-bordered p-0"
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($homeworks as $homework)
                                            <tr>
                                                ...
                                                <td>
                                                    <button type="button" class="btn btn-danger btn-sm"
                                                        data-toggle="modal" data-target="#delete{{ $homework->id }}"
                                                        title="Delete"><i class="fa fa-trash"></i></button>
                                                    <a href="{{ route('downloadAttachment', $homework->h_file) }}"
                                            ...
                                            <div class="modal fade" id="delete{{ $homework->id }}" tabindex="-1"
                                                    ...
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 style="font-family: 'Cairo', sans-serif;"
                                                                ...
                                                                {{trans('homework_trans.Delete_Homework')}}
                                                            </h5>
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="{{ route('delete.homework', $homework->id) }}"
                                                                method="post">
                                                                @csrf
                                                                {{trans('homework_trans.Delete_Homework_Sure')}}
                                                                <input id="id" type="hidden" name="id"
                                                                    class="form-control" value="{{ $homework->id }}">
                                                                <div class="modal-footer">
                                                                    <button type="button" class="btn btn-secondary"
                                                                        data-dismiss="modal">{{trans('homework_trans.Close')}}</button>
                                                                    <button type="submit"
                                                                        class="btn btn-danger">{{trans('homework_trans.Delete')}}</button>
                                                                </div>
                                                            </form>
                                                        </div>
                                                    </div>
                ...
                <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog"
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <!-- add_form -->
                                <form action="{{ route('add.homework') }}" method="post" autocomplete="off"
                                    ...
                                    <div class="section-field mb-20">
                                        <label for="subject_id" class="mb-10">{{trans('homework_trans.Subject')}} </label>
                                        <select class="form-control" name="subject_id" class="custom-select"
                                            required>
                                            <option value="" selected disabled> --------{{trans('homework_trans.Choose_Subject')}}-------
                                            </option>
                                    ...
                                    <div class="form-row">
                                        <div class="col">
                                            <label for="title">{{trans('homework_trans.File')}}</label>
                                    ...
                                    <button class="btn btn-success btn-sm nextBtn btn-lg pull-right"
                                        type="submit">{{trans('homework_trans.Add_New')}}</button>
                                </form>
                            </div>
                        </div>
                    </div>
