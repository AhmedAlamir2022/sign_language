...
<head>
    <title>{{ trans('admin_trans.Title') }} - {{trans('main_trans.Main_Title')}}</title>
    <meta charset="utf-8">
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            <div class="page-title">
                <div class="row">
                    <div class="col-sm-6">
                        <h4 class="mb-0" style="font-family: 'Cairo', sans-serif;"> {{ trans('admin_trans.Title') }}
                        </h4>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb pt-0 pr-0 float-left float-sm-right ">
                            ...
                            <li class="breadcrumb-item active">{{ trans('admin_trans.Title') }}</li>
                        </ol>
                    </div>
                </div>
            </div>
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($admins as $admin)
                                            <tr>
                                                ...
                                                <td>{{ $admin->contact }}</td>
                                                <td>{{ $admin->address }}</td>
                                                <td>{{ Carbon\Carbon::parse($admin->created_at)->diffForHumans() }}
                                                </td>
                                                <td>
                                                    ...
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 style="font-family: 'Cairo', sans-serif;"
                                                                ...
                                                                {{trans('admin_trans.Delete_Admin')}}
                                                            </h5>
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="{{ route('delete.admin', $admin->id) }}"
                                                                method="post">
                                                                @csrf
                                                                {{trans('admin_trans.Delete_Admin_Sure')}}
