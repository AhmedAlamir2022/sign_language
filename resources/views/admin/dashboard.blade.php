                        ...
                        <div class="card-body">
                            <div class="clearfix">
                                ...
                                <div class="float-right text-right">
                                    <p class="card-text text-dark">{{ trans('main_trans.Instructors') }}</p>
                                    <h4>{{ \App\Models\Instructor::count() }}</h4>
                                </div>
                            </div>
                            <p class="text-muted pt-3 mb-0 mt-2 border-top">
                                <a href="{{ route('all.inst') }}"><i class="fa fa-exclamation-circle mr-1" aria-hidden="true"></i>{{ trans('main_trans.All_Instructors') }}
                            </p></a>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-6 col-md-6 mb-30">
                    <div class="card card-statistics h-100">
                        <div class="card-body">
                            ...
                            <p class="text-muted pt-3 mb-0 mt-2 border-top">
                                <a href="{{ route('all.students') }}"><i class="fa fa-users mr-1" aria-hidden="true"></i> {{ trans('main_trans.All_Students') }}</a>
                            </p>
                        </div>
                    </div>
                </div>
