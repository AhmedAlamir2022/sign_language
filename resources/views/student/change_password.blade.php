            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb pt-0 pr-0 float-left float-sm-right ">
                        <li class="breadcrumb-item"><a href="{{ route('dashboard') }}" class="default-color">{{trans('passwords.Dashboard')}}</a></li>
                    ...
                    <div class="card-body">
                        ...
                        <div class="col-xs-12">
                            <div class="col-md-12"><br>
                                <form action="{{ route('student.update.password') }}" method="post" autocomplete="off">
                                    @csrf
                                    <div class="form-row">
                                        <div class="col">
