                                ...
                                <table id="datatable" class="table  table-hover table-sm table-bordered p-0"
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th>{{trans('books_trans.Insrtuctor')}}</th>
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($books as $book)
                                            <tr>
                                                ...
                                                <td>{{ $book->Instructors->name }}</td>
                                                <td>{{ $book->file }}</td>
                                                <td><a href="{{ route('download.student.book', $book->file) }}"
                                                        title="{{trans('books_trans.Download')}}" class="btn btn-warning btn-sm" role="button"
                                                        aria-pressed="true"><i class="ti-download"></i></a></td>
                                            </tr>
                                        @endforeach
                                </table>
                            </div>
