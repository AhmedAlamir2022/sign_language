    ...
    <ul class="nav navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown mr-30">
            ...
            <div class="dropdown-menu dropdown-menu-right">
                ...
                <div class="dropdown-divider"></div>
                <a class="dropdown-item" href="{{ route('student.change.password') }}"><i
                        class="text-info ti-settings"></i>{{trans('main_trans.ChangePassword')}}</a>
                <div class="dropdown-divider"></div>
                <a class="dropdown-item" href="{{ route('student.logout') }}"><i class="text-info ti-lock"></i>{{trans('main_trans.Logout')}}</a>
            </div>
        </li>
    </ul>
</nav>
