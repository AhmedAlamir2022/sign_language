...
<head>
    ...
    <title>Student Register - Progress Tracker</title>
    <!-- Favicon -->
            ...
            <div class="row justify-content-center no-gutters vertical-align">
                ...
                <div class="col-lg-6 col-md-8 bg-white">
                    <div class="login-fancy pb-40 clearfix">
                        <h3 style="font-family: 'Cairo', sans-serif" class="mb-30">Student Register</h3>
                        ...
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="section-field">
                                <div class="remember-checkbox mb-30">
                                    <a href="{{ route('login') }}" class="float-right">have an account ?</a>
                                </div>
                            </div>
